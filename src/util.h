...
#define SAFE_ADD(DEST, A, B) _Generic((A), \
    int8_t: dutl_internal_i8_add, \
    int16_t: dutl_internal_i16_add, \
    int32_t: dutl_internal_i32_add, \
    int64_t: dutl_internal_i64_add, \
    uint8_t: dutl_internal_u8_add, \
    uint16_t: dutl_internal_u16_add, \
    uint32_t: dutl_internal_u32_add, \
    uint64_t: dutl_internal_u64_add \
)((DEST), (A), (B))
#endif
