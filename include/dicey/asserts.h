...
// Still, if some smarty pants has the sudden urge to build this on a weird platform that Unreal clearly doesn't
// support, this header will be here to stop them.
